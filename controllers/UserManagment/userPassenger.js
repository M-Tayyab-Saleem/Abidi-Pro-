...
const createPassenger = async (req, res) => {
  ...
  try {
    ...
    if (passengerExists) {
      return res
        .status(400)
        .json({ message: "Passenger with this contact number already exists" });
    }
    ...
    res
      .status(500)
      .json({ error: "Error creating passenger", details: error.message });
  }
};
...
const getPassengerById = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ error: "Error retrieving passenger", details: error.message });
  }
};
